            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
              <div className="col-span-full md:col-start-1 md:col-end-4 xl:me-[100px] lg:me-[50px] md:me-[10px] me-0">
                <div className="tite-sec flex justify-start flex-col gap-[16px]">
                  ...
                  <h3 className="text-white text-[20px] md:text-[28px]">
                    Strategic design to
              ...
              <div className="col-span-full md:col-span-3 md:col-end-7 xl:ms-[100px] lg:ms-[50px] md:ms-[10px] ms-0">
                <h5 className="text-[#A8A8A8] mt-[24px] md:mt-[48px] text-[14px] md:text-[16px]">
                  We specialize in crafting expertly designed, conversion
                  focused websites and brands for coaches ready to become
                  industry leaders. Our work helps you expand your reach and
                  attract premium opportunities while you focus on what you do
                ...
                <h5 className="text-[#A8A8A8] mt-[18px] md:mt-[28px] text-[14px] md:text-[16px]">
                  ...
                  strategy, design and development to grow your business, build
                  deep connections, and drive meaningful change in the world.
                </h5>
              </div>
            </div>

            <div className="image-container  lg:mt-[80px] mt-[60px] rounded-[20px]">
              <Image
