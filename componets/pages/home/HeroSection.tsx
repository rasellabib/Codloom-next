...
const HeroSection = ({ handleSmoothScroll }: { handleSmoothScroll: (e: React.MouseEvent, target: string) => void }) => {
  return (
    <section id="home">
      <div className="container">
        <div className="hero-content-wrap bg-white rounded-[30px] p-tb mt-[80px] md:mt-[92px]">
          <div className="hero-content w-full md:max-w-[560px] lg:max-w-[740px] m-auto">
            <h2 className="text-center">
              Take your <br />
              <span className="italic text text-[#FF6817] letter-space4 castoro">
                coaching business
              </span>{" "}
              <br />
              to the next level
          ...
          <div className="hero-button m-auto mt-[32px] flex justify-center">
            <button
              className="relative group h5 cal-sans flex gap-[16px] bg-black text-white font-semibold pl-[24px] pr-[10px] md:py-[10px] py-[8px] h5 rounded-full items-center hover:cursor-pointer overflow-hidden transition-all duration-500"
      ...
      <div className="marquee mb-[40px]">
        <div className="marquee-inner h1 text-2xl">
